...
ActiveRecord::Schema.define(version: 2020_11_25_122162) do
  ...
  create_table "spina_blog_posts", id: :serial, force: :cascade do |t|
    ...
    t.string "seo_title"
    t.text "description"
    t.boolean "corp", default: false, null: false
    t.boolean "back_office", default: false, null: false
    t.index ["back_office"], name: "index_spina_blog_posts_on_back_office"
    t.index ["category_id"], name: "index_spina_blog_posts_on_category_id"
    t.index ["corp"], name: "index_spina_blog_posts_on_corp"
    t.index ["draft"], name: "index_spina_blog_posts_on_draft"
    t.index ["featured"], name: "index_spina_blog_posts_on_featured"
    t.index ["image_id"], name: "index_spina_blog_posts_on_image_id"
    t.index ["published_at"], name: "index_spina_blog_posts_on_published_at"
